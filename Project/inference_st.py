...
class ASR(sb.Brain):
    ...
    def on_stage_end(self, stage, stage_loss, epoch):
        ...
        if stage == sb.Stage.VALID:
            ...
            #wandb.log({"epoch": epoch, "lr": old_lr_model, "WER": stage_stats["WER"], "loss": stage_stats["loss"]})
...
if __name__ == "__main__":
    ...
    #    project="train_speech_tokenizer",
    #    # Track hyperparameters and run metadata
    #    config={
    #        "backbone": hparams["wandb_log_model_backbone"],
    #        "model_name": hparams["wandb_log_model"],
...
#
    ...
    vocab_list = list(ind2lab.values())
...
#
    ...
    transcripts = asr_brain.transcribe_dataset(
        dataset=test_datasets['test-clean'], # Must be obtained from the dataio_function
